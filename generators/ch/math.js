...
Blockly.Ch['math_arithmetic'] = function(block) {
  ...
  var OPERATORS = {
    'ADD': [' + ', Blockly.Ch.ORDER_ADDITION],
    'MINUS': [' - ', Blockly.Ch.ORDER_SUBTRACTION],
    'MULTIPLY': [' * ', Blockly.Ch.ORDER_MULTIPLICATION],
    'DIVIDE': [' / ', Blockly.Ch.ORDER_DIVISION],
    'POWER': [null, Blockly.Ch.ORDER_COMMA]  // Handle power separately.
  };
...
Blockly.Ch['math_single'] = function(block) {
  ...
  if (operator == 'NEG') {
    ...
    arg = Blockly.Ch.valueToCode(block, 'NUM',
        Blockly.Ch.ORDER_UNARY_NEGATION) || '0';
    if (arg[0] == '-') {
      // --3 is not legal in JS.
      arg = ' ' + arg;
    }
    code = '-' + arg;
    return [code, Blockly.Ch.ORDER_UNARY_NEGATION];
  }
  if (operator == 'SIN' || operator == 'COS' || operator == 'TAN') {
    arg = Blockly.Ch.valueToCode(block, 'NUM',
        Blockly.Ch.ORDER_DIVISION) || '0';
  } else {
    arg = Blockly.Ch.valueToCode(block, 'NUM',
  ...
  return [code, Blockly.Ch.ORDER_DIVISION];
};

Blockly.Ch['math_constant'] = function(block) {
  // Constants: PI, E, the Golden Ratio, sqrt(2), 1/sqrt(2), INFINITY.
  var CONSTANTS = {
    'PI': ['Math.PI', Blockly.Ch.ORDER_MEMBER],
    'E': ['Math.E', Blockly.Ch.ORDER_MEMBER],
    'GOLDEN_RATIO':
        ['(1 + Math.sqrt(5)) / 2', Blockly.Ch.ORDER_DIVISION],
    'SQRT2': ['Math.SQRT2', Blockly.Ch.ORDER_MEMBER],
    'SQRT1_2': ['Math.SQRT1_2', Blockly.Ch.ORDER_MEMBER],
...
Blockly.Ch['math_number_property'] = function(block) {
  ...
  if (dropdown_property == 'PRIME') {
    ...
    var functionName = Blockly.Ch.provideFunction_(
        'math_isPrime',
        [ 'function ' + Blockly.Ch.FUNCTION_NAME_PLACEHOLDER_ + '(n) {',
...
Blockly.Ch['math_on_list'] = function(block) {
  ...
  switch (func) {
    case 'SUM':
      list = Blockly.Ch.valueToCode(block, 'LIST',
...
Blockly.Ch['math_modulo'] = function(block) {
  ...
  return [code, Blockly.Ch.ORDER_MODULUS];
};
...
Blockly.Ch['math_constrain'] = function(block) {
  ...
  var argument2 = Blockly.Ch.valueToCode(block, 'HIGH',
      Blockly.Ch.ORDER_COMMA) || 'Infinity';
...
Blockly.Ch['math_random_float'] = function(block) {
  ...
  return ['Math.random()', Blockly.Ch.ORDER_FUNCTION_CALL];
};
