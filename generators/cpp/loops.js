...
Blockly.Cpp['controls_repeat'] =
    Blockly.Cpp['controls_repeat_ext'];
...
Blockly.Cpp['controls_forEach'] = function(block) {
  ...
  if (!argument0.match(/^\w+$/)) {
    listVar = Blockly.Cpp.variableDB_.getDistinctName(
        variable0 + '_list', Blockly.Variables.NAME_TYPE);
    code += 'var ' + listVar + ' = ' + argument0 + ';\n';
  }
  var indexVar = Blockly.Cpp.variableDB_.getDistinctName(
      variable0 + '_index', Blockly.Variables.NAME_TYPE);
  branch = Blockly.Cpp.INDENT + variable0 + ' = ' +
      listVar + '[' + indexVar + '];\n' + branch;
