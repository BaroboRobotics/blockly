...
Blockly.Cpp['math_arithmetic'] = function(block) {
  ...
  var OPERATORS = {
    ...
    'POWER': [null, Blockly.Cpp.ORDER_COMMA]  // Handle power separately.
  };
...
Blockly.Cpp['math_constant'] = function(block) {
  ...
  var CONSTANTS = {
    'PI': ['Math.PI', Blockly.Cpp.ORDER_MEMBER],
    'E': ['Math.E', Blockly.Cpp.ORDER_MEMBER],
    'GOLDEN_RATIO':
        ['(1 + Math.sqrt(5)) / 2', Blockly.Cpp.ORDER_DIVISION],
    'SQRT2': ['Math.SQRT2', Blockly.Cpp.ORDER_MEMBER],
    'SQRT1_2': ['Math.SQRT1_2', Blockly.Cpp.ORDER_MEMBER],
...
Blockly.Cpp['math_constrain'] = function(block) {
  ...
  var argument2 = Blockly.Cpp.valueToCode(block, 'HIGH',
      Blockly.Cpp.ORDER_COMMA) || 'Infinity';
...
Blockly.Cpp['math_random_float'] = function(block) {
  ...
  return ['Math.random()', Blockly.Cpp.ORDER_FUNCTION_CALL];
};
